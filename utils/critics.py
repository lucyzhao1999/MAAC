...
class AttentionCritic(nn.Module):
    ...
    def __init__(self, sa_sizes, hidden_dim=32, norm_in=True, attend_heads=1):
        ...
        Inputs:
            ...
            attend_heads (int): Number of attention heads to use (use a number that hidden_dim is divisible by)
        """
    ...
    def forward(self, inps, agents=None, return_q=True, return_all_q=False,
        ...
        for i, a_i in enumerate(agents):
            ...
            int_acs = actions[a_i].max(dim=1, keepdim=True)[1] #TODO don't understand
