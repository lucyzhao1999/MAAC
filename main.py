...
if __name__ == '__main__':
    ...
    parser.add_argument("--env_id", default="fullobs_collect_treasure", type=str)
    parser.add_argument("--model_name", default="collTreasureCollection", type=str)
    parser.add_argument("--n_rollout_threads", default=2, type=int)# 12
